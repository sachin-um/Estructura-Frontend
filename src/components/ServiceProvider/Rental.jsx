  ...
  {/* Rental Store Signup*/}
                ...
                >
                 {<Grid style={{justifyContent:"center"}}>
                  <TextField  InputProps={{ sx: { borderRadius: 2 } }}sx={{ width: 1,margin:1 }}type='RentalStoreName' name='RentalStoreName' label='Rental Company Name' variant="filled" size="small"  />
                  
                  <FormControl fullWidth variant="filled"  InputProps={{ sx: { borderRadius: 2 } }}sx={{ width: 1,margin:1 }}>
                  <InputLabel id="SelectRentalCategory">Rental Category</InputLabel>
                  <Select
                      labelId="demo-simple-select-label"
                  
                  >
                      <MenuItem value={1}>Heavy Machinery</MenuItem>
                      <MenuItem value={2}>Tools and Equipment</MenuItem>
                      <MenuItem value={3}>Portable Machines</MenuItem>
