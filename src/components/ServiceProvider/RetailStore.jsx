...
{/* Retail Store Signup*/}
              ...
              >
               {<Grid style={{justifyContent:"center"}}>
                <TextField  InputProps={{ sx: { borderRadius: 2 } }}sx={{ width: 1,margin:1 }}type='RetailStoreName' name='RetailStoreName' label='Retail Store Name' variant="filled" size="small"  />
