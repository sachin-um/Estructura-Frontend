...
import { Grid, Typography, Card, CardContent, Avatar, Rating } from '@mui/material';
  ...
  return (
    ...
    <Card style={{width: '80%', margin:'2rem auto' }}>
      <CardContent>
        ...
        <Typography variant='body1' style={{ marginTop: '1.5rem' }}>
          It was an absoulte pleasure working with Urban Architecture. John was very professional and great to work with! He exceeded my expectations and I highly recommend him!
        </Typography>
