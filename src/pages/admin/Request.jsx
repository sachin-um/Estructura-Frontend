...
const Request = () => {
  ...
  const tableTitles = ["Architects", "Interior Designers", "Home Builders", "Landscape Architects", "Painters", "Carpenters", "Construction Companies", "Renters", "Retail Stores"];
  ...
  const generateColumns = (headerName) => [
    ...
    { field: "email", headerName: "Email", flex: 1 },
    {
      ...
      renderCell: (params) => (
        <Box>
          <Button variant="outlined" color="primary" onClick={handleOpenPopover}>View</Button>
          <Button variant="outlined" color="success" onClick={() => handleEnable(params.row)}>Accept</Button>
          <Button variant="outlined" color="secondary" onClick={() => handleRemove(params.row)}>Decline</Button>
        </Box>
      ),
    },
  ];
  ...
  const generateData = (title) => {
    ...
    if (title === "Architects") {
      return [
        { id: 1, registrarId: 101, name: "John Doe", age: 30, phone: "123-456-7890", email: "john@example.com" },
        { id: 2, registrarId: 102, name: "Jane Smith", age: 25, phone: "987-654-3210", email: "jane@example.com" },
