...
const Banner = styled.div`
  width: 100%;
  height: 300px;
  background-image: url('https://www.tafensw.edu.au/api/assets/img?path=Course-Areas/Design-and-Media/interior-design.jpg');
...
const AllInteriorDesigners = () => {
  const [sortedData, setSortedData] = useState(InteriorDesigners);
  ...
  return (
    <Container>
      ...
      <Banner>Interior Designers</Banner>
      {/* <SortContainer>
        <SortIcon />
...
export default AllInteriorDesigners;
