...
const Banner = styled.div`
  width: 100%;
  height: 300px;
  background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSB6ACqeHE9OwSVB4pwIq2RmQEXWTyS7W7cxkGRBXPzdi9pNz4i3dvA8o0aH_hz5PKajk8&usqp=CAU');
...
const AllLandscapeArchitects = () => {
  const [sortedData, setSortedData] = useState(LandscapeArchitects);
  ...
  return (
    <Container>
      ...
      <Banner>Landscape Architects</Banner>
      {/* <SortContainer>
        <SortIcon />
...
export default AllLandscapeArchitects;
