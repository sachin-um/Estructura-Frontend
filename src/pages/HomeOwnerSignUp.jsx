    ...
    return <>
        ...
        <Container maxWidth="sm" sx={{marginTop:'20px'}}>
            ...
            sx={{
                ...
                <Typography variant="h4" sx={{textAlign:"center"}}>Sign up as a Homeowner</Typography>
                <TextField type="email" label="Email" />
                <Grid container style={{justifyContent:'space-between'}}>
                    <TextField type="text"  label="First Name" />
                    <TextField type="text"  label="Last Name" />
                </Grid>
                <TextField type="tel" inputProps={{pattern:/(\+94\d{9})|0\d{9}/,maxLength:12}} label="Contact Number" />
