...
const Billing = () => {
  ...
  const handleAddPaymentMethod = () => {
    const newPaymentMethod = prompt(
      'Enter the new payment method (e.g., PayPal):',
    );
    if (newPaymentMethod) {
  ...
  const handleEditPaymentMethod = (methodToEdit) => {
    const updatedMethod = prompt(
      `Edit payment method "${methodToEdit}":`,
      methodToEdit,
    );
    if (updatedMethod) {
      setPaymentMethods((prevMethods) =>
        prevMethods.map((method) =>
          method === methodToEdit ? updatedMethod : method,
        ),
      );
    }
  };
              ...
              >
                <Card
                  ...
                  sx={{
                    ...
                    backgroundColor: isStandardPlanActive
                      ? '#ffffff'
                      : '#DFF0D8',
                  }}
                >
                        ...
                        <FormControlLabel
                          ...
                          label={
                            <Typography
                              variant="body1"
                              fontWeight={
                                isStandardPlanActive ? 'bold' : 'normal'
                              }
                              sx={{ fontSize: '1.3rem' }}
                            >
                              Standard Plan
                ...
                <Card
                  ...
                  sx={{
                    ...
                    borderRadius: 7,
                    transition: 'transform 0.2s ease',
                    backgroundColor: isPremiumPlanActive
                      ? '#ffffff'
                      : '#DFF0D8',
                  }}
                >
                        ...
                        <FormControlLabel
                          ...
                          label={
                            <Typography
                              variant="body1"
                              fontWeight={
                                isPremiumPlanActive ? 'bold' : 'normal'
                              }
                              sx={{ fontSize: '1.3rem' }}
                            >
                              Premium Plan
              ...
              >
                ...
                >
                  ...
                  <Button
                    ...
                    sx={{ gap: '1rem', marginTop: '1rem', width: '15rem' }}
                  >
                    + New Payment Method
                  </Button>
                  <Popover
